...
- [~] **Dashboard v2.5** â GitHub auto-deploys to GitHub Pages. Features: Personal/Work toggle, mode-aware Brief, Focus mode, deadline system, Pick for Me, task filtering, XP/streaks, GitHub Gist cloud sync
- [x] **Set up GitHub repo for all Projects** â Done. Private repo at github.com/yohanloyer1-dev/Projects, fully backed up as of 2026-03-27.
- [?] **Netlify hosting** â Usage limit hit again (free plan). Resets ~Apr 1. Consider upgrading to Pro ($19/mo) or switching to GitHub Pages (free, no limits). Dashboard code is fine â it's a hosting-only issue.
- [x] **Add N8N/ai_agents_az/ to .gitignore** â Done. Entry already present in .gitignore (commit 87e6ea4).
...
### ð° Admin & Finance
- [x] **Pay Axon investment** â URGENT payment
...
### ð  Real Estate
- [x] **Gather docs CrÃ©dit CoopÃ©ratif** â Done 29 Mar 2026
- [x] **Cancel BP account** â Done 28 Mar 2026
- [x] **Sign Loan Insurance** â Done 30 Mar 2026
- [x] **Negotiate NL document translation** â Done 28 Mar 2026

### âï¸ Japan Trip
- [x] **Book flights Japan** â Done
- [!] **Book hotel Taiwan May 9th** â Taiwan leg of Asia trip
- [x] **Make international driving license request** â Required for car rentals in Japan
- [x] **Driving license translation** â Required for car rentals in Japan
...
- [x] **Book flight Amsterdam** â Done
- [x] **Book flight Barcelona** â Done
...
### ð¤ Presentations & Events
- [x] **Slides Fashion Commerce** â Done
...
- [x] **Ping Spanish partners + Blas** â Done
- [x] **Send follow-up email to LTVPlus team** â Done 27 Mar 2026
...
- [_] **Push NÃ©buleuse project files to GitHub** â Deferred until Phase 2 (file organization) complete. Untracked: 528+ files (AI Agent data, One Pilot guidance, financial models, etc.)
...
- [~] **Help Center scraping** â Scheduled Mondays 9am Â· Phase 1: new articles only
...
- [x] **Pay Didier Degrandi** â Done ~week of 23 Mar 2026
